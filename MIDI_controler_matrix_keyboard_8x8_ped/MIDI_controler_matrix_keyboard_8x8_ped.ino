...
const uint8_t addresses[8][8] = {   // 8 wiersze i 8 kolumn the note numbers corresponding to the buttons in the matrix
...
ButtonMatrix<8, 8> buttonmatrix( {11, 12, A0, A1, A2, A3, A4, A5}, {3, 4, 5, 6, 7, 8, 9, 10}, addresses, 2, velocity);
